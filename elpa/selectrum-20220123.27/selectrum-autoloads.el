...
Minor mode to use Selectrum for `completing-read'." :global t :group (quote selectrum) (if selectrum-mode (progn (selectrum-mode -1) (setq selectrum-mode t) (setq selectrum--old-completing-read-function (default-value (quote completing-read-function))) (setq-default completing-read-function (function selectrum-completing-read)) (setq selectrum--old-read-buffer-function (default-value (quote read-buffer-function))) (setq-default read-buffer-function (function selectrum-read-buffer)) (setq selectrum--old-read-file-name-function (default-value (quote read-file-name-function))) (setq-default read-file-name-function (function selectrum-read-file-name)) (setq selectrum--old-completion-in-region-function (default-value (quote completion-in-region-function))) (when selectrum-complete-in-buffer (setq-default completion-in-region-function (function selectrum-completion-in-region))) (advice-add (function completing-read-multiple) :override (function selectrum-completing-read-multiple)) (advice-add (quote dired-read-dir-and-switches) :around (function selectrum--fix-dired-read-dir-and-switches)) (advice-add (quote read-library-name) :override (function selectrum-read-library-name)) (advice-add (function minibuffer-message) :around (function selectrum--fix-minibuffer-message)) (define-key minibuffer-local-map [remap previous-matching-history-element] (quote selectrum-select-from-history))) (when (equal (default-value (quote completing-read-function)) (function selectrum-completing-read)) (setq-default completing-read-function selectrum--old-completing-read-function)) (when (equal (default-value (quote read-buffer-function)) (function selectrum-read-buffer)) (setq-default read-buffer-function selectrum--old-read-buffer-function)) (when (equal (default-value (quote read-file-name-function)) (function selectrum-read-file-name)) (setq-default read-file-name-function selectrum--old-read-file-name-function)) (when (equal (default-value (quote completion-in-region-function)) (function selectrum-completion-in-region)) (setq-default completion-in-region-function selectrum--old-completion-in-region-function)) (advice-remove (function completing-read-multiple) (function selectrum-completing-read-multiple)) (advice-remove (quote dired-read-dir-and-switches) (function selectrum--fix-dired-read-dir-and-switches)) (advice-remove (quote read-library-name) (function selectrum-read-library-name)) (advice-remove (function minibuffer-message) (function selectrum--fix-minibuffer-message)) (when (eq (lookup-key minibuffer-local-map [remap previous-matching-history-element]) (function selectrum-select-from-history)) (define-key minibuffer-local-map [remap previous-matching-history-element] nil))))
